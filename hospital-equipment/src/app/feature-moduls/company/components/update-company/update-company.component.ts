...
export class UpdateCompanyComponent {
  ...
  getAvailableEquipmentForCompany() {
    this.companyService
      .getAvailableEquipmentForCompany(this.company.id)
      .subscribe({
        next: (response) => {
  ...
  getEquipmentAmountByCompany(equipmentId: number) {
    this.companyService
      .getEquipmentAmountForCompany(this.company.id, equipmentId)
      .subscribe({
        next: (response) => {
  ...
  editEquipment(equipment: Equipment, amount: number) {
    ...
    this.companyService
      .updateAmount(this.company.id, equipment.id, amount)
      .subscribe({
        next: (response) => {
          console.log(response);
        },
